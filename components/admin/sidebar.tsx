...
const NAV_ITEMS: NavItem[] = [
  { key: "dashboard", href: "/admin/dashboard", icon: Home, label: "Tableau de bord" },
  { key: "calendar", href: "/admin/calendar", icon: Calendar, label: "Calendrier" },
  { key: "reservations", href: "/admin/reservations", icon: ClipboardList, label: "Réservations" },
  { key: "properties", href: "/admin/properties", icon: Building2, label: "Hébergements" },
  ...
  { key: "reports", href: "/admin/reports", icon: LineChart, label: "Rapports" },
  { key: "settings", href: "/admin/settings", icon: Settings, label: "Paramètres" },
];
